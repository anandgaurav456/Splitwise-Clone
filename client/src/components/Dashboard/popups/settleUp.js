        ...
        <div className="flx">
          <div className="frnd-content">
            ...
            <div className="frnd-set">
              <button onClick={this.PaidBy.bind(this)}>
                {this.state.byValue === "you"
                  ? "you"
                  : this.state.byValue.slice(0, 6) + "..."}
              </button>{" "}
              paid{" "}
              <button onClick={this.PaidTo.bind(this)}>
          ...
          {this.state.paidBy && (
            <PaidBy
              list={this.props.user.friends}
              byValue={this.byValue.bind(this)}
            />
          )}
          {this.state.paidTo && (
            <PaidTo
              list={this.props.user.friends}
              toValue={this.toValue.bind(this)}
            />
          )}
        </div>
      </div>
