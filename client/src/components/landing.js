      ...
      <main>
        <div className="landing-heading">
          ...
          <img
            ...
            src={require("../images/dsiplay.png")}
            alt=""
          />
        </div>
        ...
        <div className="landing-feature">
          <div>
            <img
              ...
              src={require("../images/splitwise.png")}
              alt=""
            />
          </div>
          <div className="landing-content">
            ...
            <ul>
              <li>
                <i class="fas fa-check-circle"></i> &nbsp;&nbsp;Share bills and
                IOUs,
              </li>
              <li>
              ...
              <li>
                <i class="fas fa-check-circle"></i> &nbsp;&nbsp;Totally Free for
